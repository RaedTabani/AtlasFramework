...
using DeviGames.Atlas.Core.Sequence.Installation;
...
namespace DeviGames.Playground.Bootstrap
{
    public sealed class RegisterPlaygroundServicesStep : IBootstrapStep
    {
            ...
            BootstrapContext context)
        {
            ...
            new SequenceInstaller().Install(installationContext);
            ...
            new SequenceContentIntegrationInstaller().Install(installationContext);
